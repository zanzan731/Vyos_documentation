...
\begin{itemize}
  ...
  \item \textbf{Host-firewall} (vsak strežnik in vsaka delovna postaja): default-deny inbound, dovoljenje samo za nujne storitve; admin dostop omejen na internal in VPN izvoru.
...
\hline
\textbf{Service} & \textbf{Host} & \textbf{Port (protokol)} & \textbf{Public?} & \textbf{Notes} \\
\hline
...
Na \texttt{internal} in  \texttt{ipv6only} odjemalcih je lokalni uporabnik vedno samo \texttt{zanzan}, drugi so dodeljeni preko AD.
