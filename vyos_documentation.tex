...
\subsection{Pregled in preverjanje baze podatkov}
...
Če želite izvesti druge SQL poizvedbe, lahko ustrezno prilagodite datoteko \texttt{query-ha-db.js} in vanjo vnesete želen SQL stavek.
