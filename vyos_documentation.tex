...
\begin{itemize}
  ...
  \item Kritične administrativne in imenik storitve (AD, DNS, SNMP) dostopne samo iz internal in preko VPN (ni direktnega WAN dostopa).
...
Ta izkušnja velja za trenutno VM; v drugi fazi bo \texttt{wg-portal} nameščen na novi, čisti Ubuntu VM v DMZ, brez \texttt{pivpn}, da se obstoječa delujoča konfiguracija ne prekine.
