...
This file summarizes the effective rules in `v5.9.conf` with the numbering convention:
...
| 312 | accept | dmz-peers-to-scriptum-public | `eth1 -> eth1`, src `192.168.11.0/24`, dst `192.168.11.104:8080,4443,3443/tcp` |
